...
///
/// This function uses the loan pattern: `fun` is called back with
...
/// # Errors
///
/// This function just carries errors generated by `fun`.
///
pub fn construct_der<F>(mut fun: F) -> io::Result<Vec<u8>>
